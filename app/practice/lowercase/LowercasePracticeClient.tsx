...
const lowercaseWorkbookSteps: WorksheetStep[] = [
  ...
  },
  {
    ...
    level: 2,
    worksheetUrl: '/worksheets/letter-d.html',
  ...
  {
    id: 'letter-e',
    title: 'Worksheet 2.5: Letter e',
    friendlyTitle: 'The letter e!',
    description: 'Practice the curved shape with a line through the middle.',
    kidsDescription: 'Draw a circle with a line through the middle to make an "e"!',
    level: 2,
    worksheetUrl: '/worksheets/letter-e.html',
    skills: ['Curved lines', 'Horizontal strokes'],
    estimatedTime: '10-15 minutes',
  ...
  {
    id: 'letter-f',
    title: 'Worksheet 2.6: Letter f',
    friendlyTitle: 'The letter f!',
    description: 'Master the tall line with a cross in the middle.',
    kidsDescription: 'Draw a tall line that goes up high and down low, with a little hat in the middle!',
    level: 2,
    worksheetUrl: '/worksheets/letter-f.html',
  ...
  {
    id: 'letter-g',
    title: 'Worksheet 2.7: Letter g',
    friendlyTitle: 'The letter g!',
    description: 'Practice the round top and curved tail that goes below the line.',
    kidsDescription: 'Make a circle with a monkey tail that swings below the line!',
    level: 2,
    worksheetUrl: '/worksheets/letter-g.html',
    skills: ['Round shapes', 'Below-line strokes'],
    estimatedTime: '10-15 minutes',
  ...
  {
    id: 'letter-h',
    title: 'Worksheet 2.8: Letter h',
    friendlyTitle: 'The letter h!',
    description: 'Master the tall line with a small bump on the right.',
    kidsDescription: 'Draw a tall line, then add a small hill on the right side!',
    level: 2,
    worksheetUrl: '/worksheets/letter-h.html',
    skills: ['Tall strokes', 'Curved connections'],
    estimatedTime: '10-15 minutes',
  ...
  {
    id: 'letter-i',
    title: 'Worksheet 2.9: Letter i',
    friendlyTitle: 'The letter i!',
    description: 'Practice the short line with a dot above it.',
    kidsDescription: 'Draw a short line and put a dot on top like a cherry!',
    level: 2,
    worksheetUrl: '/worksheets/letter-i.html',
    skills: ['Short strokes', 'Precise dots'],
    estimatedTime: '10-15 minutes',
  ...
  {
    id: 'letter-j',
    title: 'Worksheet 2.10: Letter j',
    friendlyTitle: 'The letter j!',
    description: 'Master the line that goes below the line with a curve and a dot above.',
    kidsDescription: 'Draw a line that goes down and curves like a fishhook, with a dot on top!',
    level: 2,
    worksheetUrl: '/worksheets/letter-j.html',
  ...
  {
    id: 'letter-k',
    title: 'Worksheet 2.11: Letter k',
    friendlyTitle: 'The letter k!',
    description: 'Practice the tall line with two diagonal lines on the right.',
    kidsDescription: 'Draw a tall line, then add two slanted lines that point out like arms!',
    level: 2,
    worksheetUrl: '/worksheets/letter-k.html',
    skills: ['Tall strokes', 'Diagonal lines'],
    estimatedTime: '10-15 minutes',
  ...
  {
    id: 'letter-l',
    title: 'Worksheet 2.12: Letter l',
    friendlyTitle: 'The letter l!',
    description: 'Master the simple tall straight line.',
    kidsDescription: 'Draw a tall, straight line reaching for the sky!',
    level: 2,
    worksheetUrl: '/worksheets/letter-l.html',
    skills: ['Tall strokes', 'Straight lines'],
    estimatedTime: '10-15 minutes',
    color: 'from-red-400 to-red-600',
    emoji: 'l'
  },
  {
    id: 'letter-m',
    title: 'Worksheet 2.13: Letter m',
    friendlyTitle: 'The letter m!',
    description: 'Practice the line with two bumps, like small hills.',
  ...
  {
    id: 'letter-n',
    title: 'Worksheet 2.14: Letter n',
    friendlyTitle: 'The letter n!',
    description: 'Master the line with one bump, like a small hill.',
    kidsDescription: 'Draw a line with one little mountain next to it!',
    level: 2,
    worksheetUrl: '/worksheets/letter-n.html',
    skills: ['Curved connections', 'Consistent height'],
    estimatedTime: '10-15 minutes',
  ...
  {
    id: 'letter-o',
    title: 'Worksheet 2.15: Letter o',
    friendlyTitle: 'The letter o!',
    description: 'Practice making a perfect circle.',
    kidsDescription: 'Draw a circle that\'s closed all the way around like a donut!',
    level: 2,
    worksheetUrl: '/worksheets/letter-o.html',
    skills: ['Circular motion', 'Closing shapes'],
    estimatedTime: '10-15 minutes',
    color: 'from-green-400 to-green-600',
    emoji: 'o'
  },
  {
    id: 'letter-p',
    title: 'Worksheet 2.16: Letter p',
    friendlyTitle: 'The letter p!',
    description: 'Master the line that goes below the line with a circle on the right.',
    kidsDescription: 'Draw a line that goes below the line, with a bubble on the right side!',
    level: 2,
    worksheetUrl: '/worksheets/letter-p.html',
    skills: ['Below-line strokes', 'Circular shapes'],
    estimatedTime: '10-15 minutes',
    color: 'from-teal-400 to-teal-600',
    emoji: 'p'
  },
  {
    id: 'letter-q',
    title: 'Worksheet 2.17: Letter q',
    friendlyTitle: 'The letter q!',
    description: 'Practice the circle with a line that goes below on the right.',
    kidsDescription: 'Draw a circle with a tail that goes down below the line!',
    level: 2,
    worksheetUrl: '/worksheets/letter-q.html',
    skills: ['Circular shapes', 'Below-line strokes'],
    estimatedTime: '10-15 minutes',
    color: 'from-cyan-400 to-cyan-600',
    emoji: 'q'
  },
  {
    id: 'letter-r',
    title: 'Worksheet 2.18: Letter r',
    friendlyTitle: 'The letter r!',
    description: 'Master the line with a small curve at the top right.',
    kidsDescription: 'Draw a line with a little rainbow coming off the top!',
    level: 2,
    worksheetUrl: '/worksheets/letter-r.html',
    skills: ['Short curves', 'Vertical strokes'],
    estimatedTime: '10-15 minutes',
    color: 'from-blue-400 to-blue-600',
    emoji: 'r'
  },
