...
export default function IntersectingLinesWorksheetPage() {
  const worksheetConfig = {
    title: 'Worksheet 1.5: Intersecting Lines',
    instructions: 'First, trace the line for "1". Then, trace the line for "2" to make a plus or a cross!',
    level: 1,
    exerciseType: 'intersecting-lines' as const
  };
