    ...
    <div className="min-h-screen transition-all duration-500 relative overflow-hidden bg-gray-50">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-56 right-16 w-16 h-16 animate-float z-10">
          <div className="w-full h-full bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center text-white font-bold text-4xl shadow-xl">
            F
          </div>
        </div>
        ...
        {/* Practice lines */}
        <div className="absolute top-20 right-36 w-32 h-8 animate-float-slow z-10">
          <svg viewBox="0 0 150 20" className="w-full h-full drop-shadow-lg">
            <path d="M5,10 Q25,5 45,10 Q65,15 85,10 Q105,5 125,10 Q145,15 150,10" stroke="#8b5cf6" strokeWidth="3" fill="none" strokeLinecap="round"/>
          </svg>
        </div>
        
        <div className="absolute bottom-40 left-32 w-32 h-8 animate-float-delay z-10">
          <svg viewBox="0 0 150 20" className="w-full h-full drop-shadow-lg">
            <path d="M5,15 Q25,10 45,15 Q65,20 85,15 Q105,10 125,15 Q145,20 150,15" stroke="#06b6d4" strokeWidth="3" fill="none" strokeLinecap="round"/>
          </svg>
        </div>
        ...
        <div className="absolute bottom-1/4 left-20 w-14 h-14 animate-bounce-slow z-10">
          <div className="w-full h-full bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center text-white font-bold text-3xl shadow-xl">
            R
          </div>
        </div>
